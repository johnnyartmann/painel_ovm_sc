...
dfs, geojson_data, vizinhos_data = carregar_dados_processados()

if dfs is not None and geojson_data is not None and vizinhos_data is not None:
    ...
    st.session_state.vizinhos = vizinhos_data
else:
