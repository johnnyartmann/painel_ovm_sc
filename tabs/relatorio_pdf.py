    ...
    try:
        ...
        if not df_temporal.empty:
            ...
            if agrupamento == "Consolidado":
                ...
                registros_por_mes_ano = df_temporal.groupby(['ano_mes', col_agrup]).size().reset_index(name='quantidade').sort_values('ano_mes')
    ...
    try:
        if not df_geral.empty:
            ...
            if agrupamento == "Consolidado":
                ...
                mapa_agrup = {"Município": "municipio", "Mesorregião": "mesoregiao", "Associação": "associacao"}
                col_agrup = mapa_agrup.get(agrupamento, 'municipio')
                registros_por_ano = df_geral.groupby(['ano', col_agrup]).size().reset_index(name='Quantidade')
                color_param = col_agrup
    ...
    try:
        if not df_geral.empty:
            if agrupamento == "Consolidado":
                ...
                mapa_agrup = {"Município": "municipio", "Mesorregião": "mesoregiao", "Associação": "associacao"}
                col_agrup = mapa_agrup.get(agrupamento, 'municipio')
                registros_por_fato = df_geral.groupby(['fato_comunicado', col_agrup]).size().reset_index(name='Quantidade')
                color_param = col_agrup
    ...
    if total_fem > 0:
        ...
        try:
            ...
            if agrupamento == "Consolidado":
                ...
                mapa_agrup = {"Município": "municipio", "Mesorregião": "mesoregiao", "Associação": "associacao"}
                col_agrup = mapa_agrup.get(agrupamento, 'municipio')
                fem_por_mes = df_fem_temp.groupby(['ano_mes', col_agrup]).size().reset_index(name='Quantidade')
                color_param = col_agrup
        ...
        try:
            ...
            if agrupamento == "Consolidado":
                ...
                mapa_agrup = {"Município": "municipio", "Mesorregião": "mesoregiao", "Associação": "associacao"}
                col_agrup = mapa_agrup.get(agrupamento, 'municipio')
                fem_por_ano = df_feminicidio.groupby(['ano', col_agrup]).size().reset_index(name='Quantidade')
                color_param = col_agrup
        ...
        try:
            if agrupamento == "Consolidado":
                ...
                mapa_agrup = {"Município": "municipio", "Mesorregião": "mesoregiao", "Associação": "associacao"}
                col_agrup = mapa_agrup.get(agrupamento, 'municipio')
                vinculo = df_feminicidio.groupby(['relacao_autor', col_agrup]).size().reset_index(name='Quantidade')
                color_param = col_agrup
        ...
        try:
            if agrupamento == "Consolidado":
                ...
                mapa_agrup = {"Município": "municipio", "Mesorregião": "mesoregiao", "Associação": "associacao"}
                col_agrup = mapa_agrup.get(agrupamento, 'municipio')
                meio = df_feminicidio.groupby(['meio_crime', col_agrup]).size().reset_index(name='Quantidade')
                color_param = col_agrup
