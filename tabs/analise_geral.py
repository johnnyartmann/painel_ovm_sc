...
def render():
    ...
    geojson_sc = st.session_state.get('geojson_sc')
    ...
    df_dia = st.session_state.df_geral_filtrado.copy()
    ...
    with col_graf2:
        ...
        df_mes = st.session_state.df_geral_filtrado.copy()
    ...
    with col_graf3:
        ...
        df_faixa_etaria = st.session_state.df_geral_filtrado.dropna(subset=['idade_vitima']).copy()
