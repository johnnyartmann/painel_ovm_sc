...
def render():
    ...
    **O perfil da violência muda drasticamente conforme a idade da vítima?**
    ...
    st.markdown(
        "O heatmap abaixo mostra a concentração de tipos de crime em cada faixa etária. A cor mais forte identifica a faixa etária com maior incidência daquele crime específico (normalizado por coluna).")
